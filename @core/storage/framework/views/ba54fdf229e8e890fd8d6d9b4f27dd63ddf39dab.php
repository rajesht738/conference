...
<?php $__env->startSection('breadcrumb'); ?>
    <li><?php echo get_events_category_by_id($event->category_id,'link'); ?></li>
    <li><?php echo e($event->title); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('edit_link'); ?>
    <li><a href="<?php echo e(route('admin.events.edit',$event->id)); ?>"><i class="far fa-edit"></i> <?php echo e(__('Edit Event')); ?></a></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="single-event-details">
                        <div class="thumb">
                            <?php echo render_image_markup_by_attachment_id($event->image,'','full'); ?>
                        ...
                        <?php if(time() >= strtotime($event->date) && $event->available_tickets > 0): ?>
                        ...
                        <?php else: ?>
                            <div class="reserve-event-seat margin-top-30">
                                <a href="<?php echo e(route('frontend.event.booking',$event->id)); ?>" class="boxed-btn style-01"><?php echo e(get_static_option('event_single_'.$user_select_lang_slug.'_reserve_button_title')); ?></a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gcflymnysua0/public_html/conf.micropowersystem.org/@core/resources/views/frontend/pages/events/event-single.blade.php ENDPATH**/ ?>