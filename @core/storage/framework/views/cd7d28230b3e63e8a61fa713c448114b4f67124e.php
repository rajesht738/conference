...
<?php $__env->startSection('breadcrumb'); ?>
    <?php if(get_knowledgebase_topic($knowledgebase->topic_id) != 'uncategorized'): ?>
    <li><a href="<?php echo e(route('frontend.knowledgebase.category',['id' => $knowledgebase->topic_id , 'any' => Str::slug(get_knowledgebase_topic($knowledgebase->topic_id))])); ?>"><?php echo e(get_knowledgebase_topic($knowledgebase->topic_id)); ?></a></li>
    <?php endif; ?>
    <li><?php echo e($knowledgebase->title); ?></li>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/frontend/pages/knowledgebase/knowledgebase-single.blade.php ENDPATH**/ ?>