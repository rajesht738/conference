...
<?php $__env->startSection('content'); ?>
    <section class="product-content-area padding-top-120 padding-bottom-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                                        ...
                                                        <div class="shipping-table-wrap table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <span class="shipping-cost">
                                                                    <?php echo e(site_currency_symbol().$data->cost); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gcflymnysua0/public_html/conf.micropowersystem.org/@core/resources/views/frontend/pages/products/product-cart.blade.php ENDPATH**/ ?>