                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            <?php $__currentLoopData = $job; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(get_jobs_category_by_id($data->id)); ?></td>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                           ...
                                                           title=""
                                                           data-content="
                                                       <h6><?php echo e(__('Are you sure to delete this job post?')); ?></h6>
                                                       <form method='post' action='<?php echo e(route('admin.jobs.delete',$data->id)); ?>'>
                                                       ...
                                                       <br>
                                                        ...
                                                        <a class="btn btn-xs btn-primary mb-3 mr-1" href="<?php echo e(route('admin.jobs.edit',$data->id)); ?>">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-xs btn-light mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.jobs.single',$data->slug)); ?>">
                                                            <i class="ti-eye"></i>
                                                        </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/jobs/all-jobs.blade.php ENDPATH**/ ?>