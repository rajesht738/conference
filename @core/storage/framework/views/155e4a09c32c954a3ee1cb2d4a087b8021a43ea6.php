                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap">
                            ...
                            <a href="<?php echo e(route('admin.products.all')); ?>" class="btn btn-primary btn-xs"><i class="fas fa-angle-double-left"></i><?php echo e(__('All Products')); ?></a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="sale_price" name="sale_price" value="<?php echo e($product->sale_price); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <?php if(get_static_option('product_tax_type') == 'individual'): ?>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="tax_percentage" value="<?php echo e($product->tax_percentage); ?>">
                                        </div>
                                    <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/backend/products/edit-product.blade.php ENDPATH**/ ?>