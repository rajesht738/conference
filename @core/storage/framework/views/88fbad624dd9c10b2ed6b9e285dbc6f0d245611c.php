<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Feedback Form Builder')); ?>
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Feedback Form Builder")); ?></h4>
                        <p class="alert alert-info text-capitalize"><?php echo e(__('name,email,rating,description are prebuild field, skip those field')); ?></p>
                        <form action="<?php echo e(route('admin.feedback.page.form.builder')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('feedback_page_form_fields')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/pages/feedback/feedback-form-builder.blade.php ENDPATH**/ ?>