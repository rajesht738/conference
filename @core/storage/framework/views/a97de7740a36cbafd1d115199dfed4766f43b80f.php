<?php echo $__env->make('frontend.partials.navbar-02', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<section class="our-cover-area padding-top-110 padding-bottom-90">
    <div class="container">
        ...
        <div class="row">
            <?php $__currentLoopData = $all_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-blog-grid-01">
                            ...
                            <div class="content">
                                ...
                                <ul class="post-meta">
                                    ...
                                    <li><a href="<?php echo e(route('frontend.blog.single',$data->slug)); ?>"><i class="fa fa-user"></i> <?php echo e($data->user->username); ?></a></li>
                                    <li>
...
<?php endif; ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/frontend/home-pages/home-02.blade.php ENDPATH**/ ?>