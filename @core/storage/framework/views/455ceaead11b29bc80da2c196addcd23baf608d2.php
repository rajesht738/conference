<div class="widget-area">
    ...
    <div class="widget widget_nav_menu">
        <h2 class="widget-title"><?php echo e(get_static_option('blog_page_'.$user_select_lang_slug.'_category_widget_title')); ?></h2>
        <ul>
    ...
    <div class="widget widget_recent_posts">
        <h4 class="widget-title"><?php echo e(get_static_option('blog_page_'.$user_select_lang_slug.'_recent_post_widget_title')); ?></h4>
...
<?php /**PATH /home/gcflymnysua0/public_html/conf.micropowersystem.org/@core/resources/views/frontend/partials/sidebar.blade.php ENDPATH**/ ?>