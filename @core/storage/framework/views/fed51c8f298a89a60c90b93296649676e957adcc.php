...
<head>
    ...
    <title><?php echo e(__('Package Order From ').get_static_option('site_'.get_default_language().'_title')); ?></title>
    <style>
        .mail-container {
            max-width: 650px;
            margin: 0 auto;
...
<div class="mail-container">
    ...
    <p><?php echo e(__('You Have A Order Message From '. get_static_option('site_'.get_default_language().'_title'))); ?></p>
    <table>
        <tr>
...
</html><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/mail/order.blade.php ENDPATH**/ ?>