                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            <?php $__currentLoopData = $article; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($data->topic->title); ?></td>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-xs btn-danger mb-3 mr-1"
                                                           ...
                                                           title=""
                                                           data-content="
                                                           <h6><?php echo e(__('Are you sure to delete this article?')); ?></h6>
                                                           <form method='post' action='<?php echo e(route('admin.knowledge.delete',$data->id)); ?>'>
                                                        ...
                                                        <a class="btn btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.knowledge.edit',$data->id)); ?>">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-light btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.knowledgebase.single',$data->slug)); ?>">
                                                            <i class="ti-eye"></i>
                                                        </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/backend/knowledgebase/all-knowledgebase.blade.php ENDPATH**/ ?>