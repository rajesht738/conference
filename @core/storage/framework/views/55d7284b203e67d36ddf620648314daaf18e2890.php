...
<?php $__env->startSection('breadcrumb'); ?>
    <li><a href="<?php echo e(get_static_option('events_page_slug')); ?>"><?php echo e(get_static_option('events_page_'.$user_select_lang_slug.'_name')); ?></a></li>
    <li><?php echo e(get_static_option('events_page_'.$user_select_lang_slug.'_name').' '.__('Booking')); ?></li>
<?php $__env->stopSection(); ?>
                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade <?php if(auth()->check()): ?> show active <?php endif; ?>" id="nav-profile" role="tabpanel">
                                    ...
                                    <form method="post" action="<?php echo e(route('frontend.event.booking.store')); ?>" enctype="multipart/form-data">
                                        ...
                                        <?php echo csrf_field(); ?>
                                        <?php echo render_form_field_for_frontend(get_static_option('event_booking_form_fields')); ?>
                                        ...
                                        <div class="btn-wrapper">
                                            <button type="submit" class="boxed-btn style-01"><?php echo e(get_static_option('event_attendance_page_'.$user_select_lang_slug.'_form_button_title')); ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/frontend/pages/events/event-booking.blade.php ENDPATH**/ ?>