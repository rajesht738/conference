        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <ul id="sortable_02" class="available-form-field all-widgets">
                            <?php
                                ...
                                'recent_work' => ['recent_work_widget','render_recent_work_widget'],
                                ...
                                //'text_editor' => ['text_editor_widget','render_text_editor_widget'],
                                ];
                            ?>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    ...
                    <div class="card-body widget-area-body show">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gcflymnysua0/public_html/conf.micropowersystem.org/@core/resources/views/backend/widgets/widget-index.blade.php ENDPATH**/ ?>