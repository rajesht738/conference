...
<![endif]-->
<?php if(get_static_option('site_admin_panel_preloader_enabled') == 'on'): ?>
<div id="preloader">
...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area">
            ...
            <p><?php echo e(__('Powered By ')); ?> - Ecubes</p>
        </div>
    </footer>
...
<?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>