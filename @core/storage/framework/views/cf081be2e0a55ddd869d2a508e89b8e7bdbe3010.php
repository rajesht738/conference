                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap">
                            ...
                            <a href="<?php echo e(route('admin.popup.builder.all')); ?>" class="btn btn-primary btn-xs"><i class="fas fa-angle-double-left"></i><?php echo e(__('All Popup')); ?></a>
                        </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/popup-builder/popup-edit.blade.php ENDPATH**/ ?>