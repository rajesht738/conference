                                            ...
                                            <?php $__currentLoopData = $payment_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                       ...
                                                       <form method='post' action='<?php echo e(route('admin.payment.delete',$data->id)); ?>'>
                                                       ...
                                                       <br>
                                                        ...
                                                        <a href="#"
                                                           ...
                                                           data-package_name="<?php echo e($data->package_name); ?>"
                                                           data-package_price="<?php echo e($data->package_price); ?>"
                                                           data-package_gateway="<?php echo e(ucwords(str_replace('_',' ',$data->package_gateway))); ?>"
                                                       ...
                                                       <form method='post' action='<?php echo e(route('admin.payment.approve',$data->id)); ?>'>
                                                       <input type='hidden' name='_token' value='<?php echo e(csrf_token()); ?>'>
                                                       <br>
        ...
        $(document).ready(function($) {
            $(document).on('click','.view_quote_details_btn',function (e) {
                ...
                $.each(allData,function (index,value) {
                    var itemName = value;
                    if (index == 'package_price'){
                        itemName = itemName + "<?php echo e(get_static_option('site_global_currency')); ?>" ;
                    }
                    parent.find('.quote-all-custom-fields').append('<tr><td class="fname">'+index.replace('_',' ')+'</td> <td class="fvalue">'+itemName+'</td></tr>');
                });
            });
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/payment-logs/payment-logs-all.blade.php ENDPATH**/ ?>