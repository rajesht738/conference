<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Event Booking Form Builder')); ?>
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Event Booking Form Builder")); ?></h4>
                        <form action="<?php echo e(route('admin.form.builder.event.booking')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('event_booking_form_fields')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/form-builder/event-booking-form.blade.php ENDPATH**/ ?>