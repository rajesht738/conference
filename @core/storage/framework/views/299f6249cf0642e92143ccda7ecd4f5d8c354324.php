        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                $(document).on('change','#body_font_family',function (e) {
                    ...
                    $('#typography_submit_btn').attr('disabled',true);
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            $.each(data.variants,function (index,value) {
                                variantSelector.append('<option value="'+value+'">'+value+'</option>');
                            });
                            variantSelector.niceSelect('update');
                            $('#typography_submit_btn').attr('disabled',false);
                        }
                    });
                });
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gcflymnysua0/public_html/conf.micropowersystem.org/@core/resources/views/backend/general-settings/typograhpy.blade.php ENDPATH**/ ?>