                    ...
                    <?php $__currentLoopData = $gallery_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="banner-bg banner-bg1 banner-bg1-1" data-background="<?php echo render_image_url_by_attachment_id($gall); ?>">
                                        ...
                                        <div class="col-xl-6 col-lg-7 col-md-8">
                                            <div class="banner-content banner-content1 banner-content1-1 pt-40">
                                                ...
                                                <h1 class="banner-title white-color"
                                                    data-animation="fadeInUp"data-delay=".8s"><?php echo e($work_item->title); ?></h1>
                        ...
                        <?php if(get_static_option('contact_page_google_map_section_status') == 'on'): ?>
                            <div id="map" class="col-md-5 contact_page_map">
                                ...
                                <ul style="list-style-type: square !important;">
                                    ...
                                    <li style="list-style: inherit;"><a href="<?php echo e(url('')); ?>/privacy_policy"
                                            target="_blank">Privacy Policy</a></li>
                                    <li style="list-style: inherit;"><a href="<?php echo e(url('')); ?>/term_condition"
                                            target="_blank">Terms and Conditions</a></li>
                                    <li style="list-style: inherit;"><a href="<?php echo e(url('')); ?>/cancellation_policy"
