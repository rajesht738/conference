                          ...
                          <div class="col-xl-6 col-lg-7 col-md-8">
                             <div class="banner-content banner-content1 banner-content1-1 pt-40">
                                ...
                                <div class="banner-btn one" data-animation="fadeInUp" data-delay="1.2s">
                                   <a class="theme-btn red" href="http://conf.micropowersystem.org/conferences/<?php echo e($work_item->slug); ?>/key-dates">Final Programm<i class="fal fa-arrow-alt-right"></i></a>
                                   <a class="theme-btn yellow" href="http://conf.micropowersystem.org/conferences/<?php echo e($work_item->slug); ?>/abstract-submission">Submit Presentation <i class="fal fa-arrow-alt-right"></i></a>
                                </div>
                             </div>
                          </div>
                       </div>
        ...
        <div class="row">
            <div class="container sumitAbstractWrapper">
              <div class="col-xl-9 col-lg-9 text-center">
                ...
                <a class="btn btn-lg btn-danger rounded-capsule mt-4" href="http://conf.micropowersystem.org/conferences/<?php echo e($work_item->slug); ?>/abstract-submission" title="Closed!" data-fancyscroll="data-fancyscroll">Submit now</a>
              </div>
            </div>
        </div>
    </section>
