                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="apply_job_<?php echo e($lang->slug); ?>_subject"><?php echo e(__('Apply Job Success Message')); ?></label>
                                            <input type="text" name="apply_job_<?php echo e($lang->slug); ?>_subject"  class="form-control" value="<?php echo e(get_static_option('apply_job_'.$lang->slug.'_subject')); ?>" id="apply_job_<?php echo e($lang->slug); ?>_subject">
                                            <small class="form-text text-muted"><?php echo e(__('this message will show when any one apply to a job.')); ?></small>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\conference\@core\resources\views/backend/general-settings/email-settings.blade.php ENDPATH**/ ?>