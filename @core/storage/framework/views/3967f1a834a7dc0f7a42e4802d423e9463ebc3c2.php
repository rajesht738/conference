                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.top.button')); ?>"  method="post">
                            ...
                            <div class="form-group">
                                <label for="top_bar_get_quote_btn_status"><strong><?php echo e(__('Button Show/Hide')); ?></strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="top_bar_get_quote_btn_status"  <?php if(!empty(get_static_option('top_bar_get_quote_btn_status'))): ?> checked <?php endif; ?> >
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.update.social.item')); ?>"  method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="social_item_edit_icon" class="d-block"><?php echo e(__('Icon')); ?></label>
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary iconpicker-component">
                                    <i class="fas fa-exclamation-triangle"></i>
                                </button>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.useful_link_widget_tab_item',function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.topbar.menu.by.slug')); ?>",
                    type: "POST",
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gcflymnysua0/public_html/conf.micropowersystem.org/@core/resources/views/backend/pages/top-bar.blade.php ENDPATH**/ ?>