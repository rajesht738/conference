...
<?php $__env->startSection('edit_link'); ?>
    <li><a href="<?php echo e(route('admin.products.edit',$product->id)); ?>"><i class="far fa-edit"></i> <?php echo e(__('Edit Product')); ?></a></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li><a href="<?php echo e(route('frontend.products.category',['id' => $product->category_id,'any' => Str::slug(get_product_category_by_id($product->category_id))])); ?>"><?php echo e(get_product_category_by_id($product->category_id)); ?></a></li>
                            ...
                            <div class="extra-content-wrap">
                                <nav>
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <?php endif; ?>
                                        <?php if(!empty($product->attributes_title)): ?>
                                            ...
                                            <div class="product-ratings-form">
                                                ...
                                                <?php else: ?>
                                                    <div class="login-form">
                                                        <p><?php echo e(__('Login To Leave Review')); ?></p>
                                                        ...
                                                        <form action="<?php echo e(route('user.login')); ?>" method="post"
                                                            ...
                                                            <div class="form-group btn-wrapper">
                                                                <button type="submit" id="login_btn"
                                                                        class="submit-btn"><?php echo e(__('Login')); ?></button>
                                                            </div>
                                                            <div class="row mb-4 rmber-area">
                                                                ...
                                                                <div class="col-6 text-right">
                                                                    <a class="d-block"
                                                                       href="<?php echo e(route('user.register')); ?>"><?php echo e(__('Haven\'t any account?')); ?></a>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single-product-item-3 margin-bottom-30">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-wrap">
                                                        <span
                                                            class="price"><?php echo e(site_currency_symbol().$data->sale_price); ?></span>
                                                        <?php if(!empty($data->regular_price)): ?>
                                                            <del
                                                                class="del-price"><?php echo e(site_currency_symbol().$data->regular_price); ?></del><?php endif; ?>
                                                    </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/frontend/pages/products/product-single.blade.php ENDPATH**/ ?>