                                        ...
                                        <div id="accordion-payment">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paytm_settings_content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <div class="payment-notice alert alert-warning">
                                                                <p>{{__("Available Currency For Paytm is, ['INR']")}}</p>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="stripe_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        <div class="payment-notice alert alert-warning">
                                                            <p>{{__("Stripe support all currency available currency In this cms.")}}</p>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    ...
                                                                    @if (!empty($stripe_img))
                                                                        ...
                                                                        @php  $stripe_image_btn_label = 'Change Image'; @endphp
                                                                    @endif
                                                                </div>
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    ...
                                                                    @if (!empty($razorpay_img))
                                                                        ...
                                                                        @php  $razorpay_image_btn_label = 'Change Image'; @endphp
                                                                    @endif
                                                                </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paystack_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        <div class="payment-notice alert alert-warning">
                                                            <p>{{__("Available Currency For Paystack is, ['GHS','NGN']")}}</p>
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    ...
                                                                    @if (!empty($paystack_img))
                                                                        ...
                                                                        @php  $paystack_image_btn_label = 'Change Image'; @endphp
                                                                    @endif
                                                                </div>
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    ...
                                                                    @if (!empty($mollie_img))
                                                                        ...
                                                                        @php  $mollie_image_btn_label = 'Change Image'; @endphp
                                                                    @endif
                                                                </div>
